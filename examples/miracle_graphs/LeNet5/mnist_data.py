"""
Almost identical with the one in the linear regression experiment. We don't reshape X and don't one_hot encode y here.
"""
...
class MnistData(object):
    ...
    def _preprocess_images(self, images):
        # Scale image values to be between 0 and 1
        images = tf.reshape(images, shape=[28, 28, 1]) # Expand dimensions
